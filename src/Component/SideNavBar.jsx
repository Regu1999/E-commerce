...
export default function SideNavBar({ children }) {
    ...
    return <div className={`fixed ${isView?'start-0':'left-[-100%]'}  w-full max-w-80 h-full opacity-2 shadow-lg bg-rose-100 overflow-auto pb-20 `}>
        <div className="border-b p-3 border-rose-400 flex items-center justify-between">
            ...
            <button><IoCloseSharp className="text-white text-xl" /> </button>
        </div>
        {children}
    </div>
}